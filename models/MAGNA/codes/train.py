...
def main(args):
    ...
    if hasattr(data, "features"):
        ...
        # DGL >=1.x citation datasets return a dataset object; graph/masks are in g.ndata.
        g_dgl = data[0]
        features = g_dgl.ndata['feat'].float()
        labels = g_dgl.ndata['label'].long()
        train_mask = g_dgl.ndata['train_mask'].bool()
        val_mask = g_dgl.ndata['val_mask'].bool()
        test_mask = g_dgl.ndata['test_mask'].bool()
